...
# --- ZONE 5: หน้าความรู้ (Rock Info) ---
    ...
    st.markdown("""
        <div class="result-box">
            ...
            <b>หินตะกอนเนื้อหยาบ</b>
            <p>เช่น หินทราย (Sandstone) สัมผัสแล้วระคายมือ หินกรวดมน (Conglomerate) ที่มีเศษหินกลมมน</p>
            <b>หินตะกอนเนื้อละเอียด</b>
            <p>เช่น หินดินดาน (Shale) เนื้อเนียนละเอียด มักแตกเป็นแผ่นบางๆ หินปูน (Limestone) ที่มักมีสีขาว เทา หรือชมพู</p>
            <br>
